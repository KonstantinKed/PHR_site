...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Apartments',
            fields=[
                ('apt_id', models.CharField(max_length=2, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Pics',
            fields=[
                ('pics_id', models.SmallAutoField(primary_key=True, serialize=False)),
                ('pics_link_1', models.CharField(blank=True, max_length=255, null=True)),
                ('pics_link_2', models.CharField(blank=True, max_length=255, null=True)),
                ('pics_link_3', models.CharField(blank=True, max_length=255, null=True)),
                ('pics_link_4', models.CharField(blank=True, max_length=255, null=True)),
            ],
            options={
                'db_table': 'pics',
                'managed': False,
